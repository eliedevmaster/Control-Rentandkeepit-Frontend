...
@Component({
  selector: 'app-centrepay-bulk-upload',
  templateUrl: './centrepay-bulk-upload.component.html',
  styleUrls: ['./centrepay-bulk-upload.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations   : fuseAnimations
})

export class CentrepayBulkUploadComponent implements OnInit {

  centrepayForm: FormGroup;
  user: User;
  ...
  {
      // Reactive Form
      this.centrepayForm = this._formBuilder.group({
